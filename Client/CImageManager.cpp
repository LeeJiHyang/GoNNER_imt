...
IMPLEMENT_SINGLETON(LJH::CImageManager)

LJH::CImageManager::CImageManager()
{
}
...
void LJH::CImageManager::Release()
{
...
HRESULT LJH::CImageManager::InsertImage(const wstring& strTextureKey, const wstring& strImageKey, const int& iStartIndexX, const int& iStartIndexY, const int& iMaxFrame)
{
	CTextureManager* pTextureManager = CTextureManager::GetInstance();
	CTexture* pTexture = pTextureManager->GetTexture(strTextureKey);
	if (pTexture == nullptr) return E_FAIL;

	CImage* pImage = new CImage(pTexture, strImageKey, iStartIndexX, iStartIndexY, iMaxFrame);
...
LJH::CImage * LJH::CImageManager::GetImage(const wstring & strTextureKey, const wstring & strImageKey)
{
	CTextureManager* pTextureManager = CTextureManager::GetInstance();
	CTexture* pTexture = pTextureManager->GetTexture(strTextureKey);
...
HRESULT LJH::CTextureKey::InsertImage(const wstring & strImageKey, CImage* pImage)
{
...
LJH::CImage* LJH::CTextureKey::GetImage(const wstring & strImageKey)
{
